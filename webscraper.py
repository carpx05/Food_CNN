...
for query in querys:
      ...
      service = Service(executable_path='C:/Users/ayush/Downloads/chromedriver_win32')
      ...
      c=0
      image_url=[]
      for img_result in img_results[198::]:
            WebDriverWait(
                driver,
                15
            ).until(
        ...
        value="//img[contains(@class,'r48jcc pT0Scc iPVvYb')]")
                  ...
                  download_image("E:/dataset/New Folder/", src, query+str(c) + ".jpg")
                  c=c+1
            except:
                  continue
